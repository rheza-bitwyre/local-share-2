...
with open("/home/ubuntu/Rheza/local-share/03X_ST_IC/03_live_25k/stic_binance_DOGE_config.json", "r") as file:
...
def handle_trading_action(suggested_action, prev_action=None, trade_amount_usdt=100, symbol='DOGEUSDT', API_KEY=None, API_SECRET=None, position = 2, active_pos = 1):
