...
for thresholds in threshold_combinations:
    ...
    if occ_threshold > ohc_threshold :
        logging.info("Combination Skipped as OCC > OHC!")
        continue
    ...
    logging.info(f"Results - PnL:{total_pnl_pct}%, Long Opened:{long_positions}, Median Losing Streak:{median_lose_streak}")
...
df_results.write_csv(f"/home/ubuntu/Rheza/local-share/06_trades_and_orderbooks/ft_bot_long_backtest_result_{time_start}.csv")