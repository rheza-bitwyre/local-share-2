    ...
    while True:
        ...
        if sequence is None:
            ...
            if len(confirmation_candles) == (first_confirmation_candles + 1):
                ...
                if first_candle > first_max and all(c >= first_candle for c in confirmation_candles):
                    sequence = "First Break Up Confirmed"
                    logging.info(f"Sequence Turn to {sequence} !")
                elif first_candle < first_min and all(c <= first_candle for c in confirmation_candles):
